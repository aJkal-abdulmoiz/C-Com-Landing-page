              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <motion.div variants={itemVariants} className="flex flex-col gap-2 pb-2">
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full px-5 py-4 cursor-pointer bg-gradient-to-br from-[var(--primary-green)] to-[#076b6d] text-white font-semibold text-sm rounded-lg transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_6px_16px_rgba(6,188,189,0.3)] disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:translate-y-0 flex items-center justify-center gap-2"
                  >
                    {isLoading ? (
                      <>
                        <svg
