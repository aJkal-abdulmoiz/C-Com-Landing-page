      ...
      <div className="max-w-[75rem] mx-auto px-4 py-12 w-full">
        <div className="grid lg:grid-cols-2 gap-8 items-center relative">
          ...
          <div className="space-y-6 lg:pr-8">
            {/* Top Badge */}
            <div className="inline-flex items-center space-x-2 px-3 py-1.5 rounded-full border border-[#2ecc71]/30 bg-[#2ecc71]/5">
              <svg className="w-4 h-4 text-[#2ecc71]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
              </svg>
              <span className="text-[#2ecc71] text-xs font-semibold">Conversational AI Readiness</span>
            </div>
          ...
          <div className="relative h-[500px] lg:h-[600px] flex items-center justify-center">
            <div className="relative w-full h-full max-w-[500px] mx-auto">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-32 h-32 rounded-full bg-gradient-to-br from-[#2ecc71] via-[#00ff88] to-[#2ecc71] opacity-50 blur-3xl animate-pulse-slow"></div>
              </div>

              {/* 3D Rotating Rings */}
              <div className="absolute inset-0 flex items-center justify-center perspective-1000">
                <div className="absolute w-[400px] h-[400px] animate-rotate-3d-slow-anticlockwise">
                  <div className="w-full h-full rounded-full border-2 border-[#2ecc71]/25" 
                ...
                <div className="absolute w-[340px] h-[340px] animate-rotate-3d-medium-anticlockwise">
                  <div className="w-full h-full rounded-full border-2 border-[#00ff88]/30" 
                ...
                <div className="absolute w-[260px] h-[260px] animate-rotate-3d-fast-anticlockwise delay-100">
                  <div className="w-full h-full rounded-full border-2 border-[#2ecc71]/45" 
                ...
                <div className="absolute w-[180px] h-[180px] animate-rotate-3d-fastest-anticlockwise delay-200">
                  <div className="w-full h-full rounded-full border-[1.5px] border-[#00ff88]/50" 
              ...
              <div className="absolute inset-0 flex items-center justify-center z-10">
                <div className="flex items-center space-x-1.5">
                  {[...Array(12)].map((_, i) => (
                    <div
                      key={i}
                      className="w-1 bg-gradient-to-t from-[#2ecc71] to-[#00ff88] rounded-full animate-wave"
                      style={{
                        height: '20px',
              ...
              <div className="absolute top-[15%] left-[10%] animate-float-bubble">
                <div className="bg-[#2ecc71]/10 border border-[#2ecc71]/30 rounded-2xl rounded-tr-sm px-4 py-2 backdrop-blur-sm">
                  <p className="text-[#2ecc71] text-xs font-medium">Context</p>
                </div>
              </div>

              <div className="absolute top-[30%] right-[8%] animate-float-bubble delay-200">
                <div className="bg-[#00ff88]/10 border border-[#00ff88]/30 rounded-2xl rounded-tl-sm px-4 py-2 backdrop-blur-sm">
              ...
              <div className="absolute bottom-[25%] left-[15%] animate-float-bubble delay-400">
                <div className="bg-[#2ecc71]/10 border border-[#2ecc71]/30 rounded-2xl rounded-tr-sm px-4 py-2 backdrop-blur-sm">
                  <p className="text-[#2ecc71] text-xs font-medium">Conversations</p>
                </div>
              </div>
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                ...
                {[...Array(12)].map((_, i) => (
                  <div key={`inner1-${i}`} className="absolute w-[200px] h-[200px] animate-orbit-fastest-anticlockwise" style={{ animationDelay: `-${(i / 12) * 16}s` }}>
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 w-0.5 h-0.5 bg-[#4cff9a] rounded-full shadow-sm shadow-[#4cff9a]/60 animate-merge-pulse"></div>
                  </div>
                ))}
                ...
                {[...Array(10)].map((_, i) => (
                  <div key={`inner2-${i}`} className="absolute w-[260px] h-[260px] animate-orbit-fast-anticlockwise" style={{ animationDelay: `-${(i / 10) * 18}s` }}>
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 w-0.5 h-0.5 bg-[#a8ffcb] rounded-full shadow-sm shadow-[#a8ffcb]/60 animate-merge-pulse"></div>
                  </div>
                ))}
                ...
                {[...Array(9)].map((_, i) => (
                  <div key={`middle1-${i}`} className="absolute w-[320px] h-[320px] animate-orbit-medium-anticlockwise" style={{ animationDelay: `-${(i / 9) * 22}s` }}>
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 w-0.5 h-0.5 bg-[#2ecc71] rounded-full shadow-sm shadow-[#2ecc71]/50"></div>
                  </div>
                ))}
                ...
                {[...Array(7)].map((_, i) => (
                  <div key={`middle2-${i}`} className="absolute w-[380px] h-[380px] animate-orbit-medium-anticlockwise" style={{ animationDelay: `-${(i / 7) * 22}s` }}>
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 w-0.5 h-0.5 bg-[#00ff88] rounded-full shadow-sm shadow-[#00ff88]/50"></div>
                  </div>
                ))}
                ...
                {[...Array(5)].map((_, i) => (
                  <div key={`outer1-${i}`} className="absolute w-[420px] h-[420px] animate-orbit-slow-anticlockwise" style={{ animationDelay: `-${(i / 5) * 30}s` }}>
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 w-0.5 h-0.5 bg-[#7fffc3] rounded-full shadow-sm shadow-[#7fffc3]/45"></div>
                  </div>
                ))}
                ...
                {[...Array(3)].map((_, i) => (
                  <div key={`outer2-${i}`} className="absolute w-[460px] h-[460px] animate-orbit-slowest-anticlockwise" style={{ animationDelay: `-${(i / 3) * 40}s` }}>
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 w-0.5 h-0.5 bg-[#c4ffe0] rounded-full shadow-sm shadow-[#c4ffe0]/35"></div>
                  </div>
                ))}
