...
export const metadata: Metadata = {
    ...
    openGraph: {
      ...
      images: [
        {
          url: 'https://c-com.ai/logo-social.png', // Add this image
          width: 1200,
          height: 630,
...
export default function AIPage() {
  return (
    <div className="max-w-3xl mx-auto px-6 py-12 text-gray-800">
      {/* Header */}
      <div className="mb-8">
        <p className="text-xs text-gray-500 mb-2">Chat with C-COM.AI</p>
        <h1 className="text-2xl font-semibold mb-2">C-COM.AI Knowledge Hub</h1>
        <p className="text-base text-gray-600 mb-4">Your Business, Ready for AI Discovery</p>
      ...
      <section className="mb-10">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm font-semibold mb-2">Three Categories of Moments of Meaning:</p>
          
          <div className="overflow-x-auto mb-4">
            <table className="w-full text-xs border-collapse border border-gray-300">
              <thead>
                <tr className="bg-gray-50">
                  <th className="border border-gray-300 px-3 py-2 text-left font-semibold">Moment Type</th>
                  <th className="border border-gray-300 px-3 py-2 text-left font-semibold">Replaces</th>
                  <th className="border border-gray-300 px-3 py-2 text-left font-semibold">Consumer State</th>
                  <th className="border border-gray-300 px-3 py-2 text-left font-semibold">Core Question</th>
                  <th className="border border-gray-300 px-3 py-2 text-left font-semibold">How Brands Win</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td className="border border-gray-300 px-3 py-2">Affirmation</td>
                  <td className="border border-gray-300 px-3 py-2">Branded keywords</td>
                  <td className="border border-gray-300 px-3 py-2">Already has preference</td>
                  <td className="border border-gray-300 px-3 py-2">&quot;Am I making the right choice?&quot;</td>
                  <td className="border border-gray-300 px-3 py-2">Clear, credible, steady</td>
                </tr>
                <tr>
                  <td className="border border-gray-300 px-3 py-2">Discovery</td>
                  <td className="border border-gray-300 px-3 py-2">Category keywords</td>
                  <td className="border border-gray-300 px-3 py-2">Curious, learning</td>
                  <td className="border border-gray-300 px-3 py-2">&quot;What are my options?&quot;</td>
                  <td className="border border-gray-300 px-3 py-2">Helpful educators</td>
                </tr>
                <tr>
                  <td className="border border-gray-300 px-3 py-2">Evaluation</td>
                  <td className="border border-gray-300 px-3 py-2">Competitor keywords</td>
                  <td className="border border-gray-300 px-3 py-2">Reconsidering</td>
                  <td className="border border-gray-300 px-3 py-2">&quot;What fits better now?&quot;</td>
                  <td className="border border-gray-300 px-3 py-2">Situational fit</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div className="mb-6">
          ...
          <div className="overflow-x-auto mb-4">
            <table className="w-full text-xs border-collapse border border-gray-300">
              <thead>
                <tr className="bg-gray-50">
                  <th className="border border-gray-300 px-3 py-2 text-left font-semibold">Era</th>
                  <th className="border border-gray-300 px-3 py-2 text-left font-semibold">Interface</th>
                  <th className="border border-gray-300 px-3 py-2 text-left font-semibold">Discovery</th>
                  <th className="border border-gray-300 px-3 py-2 text-left font-semibold">Imperative</th>
                  <th className="border border-gray-300 px-3 py-2 text-left font-semibold">Success Metric</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td className="border border-gray-300 px-3 py-2">1980s-2000s</td>
                  <td className="border border-gray-300 px-3 py-2">Physical</td>
                  <td className="border border-gray-300 px-3 py-2">Browse with feet</td>
                  <td className="border border-gray-300 px-3 py-2">Be physically present</td>
                  <td className="border border-gray-300 px-3 py-2">Location & shelf space</td>
                </tr>
                <tr>
                  <td className="border border-gray-300 px-3 py-2">2000s-2020s</td>
                  <td className="border border-gray-300 px-3 py-2">Search</td>
                  <td className="border border-gray-300 px-3 py-2">Think in keywords</td>
                  <td className="border border-gray-300 px-3 py-2">Be digitally present</td>
                  <td className="border border-gray-300 px-3 py-2">Search rankings</td>
                </tr>
                <tr>
                  <td className="border border-gray-300 px-3 py-2">2020s+</td>
                  <td className="border border-gray-300 px-3 py-2">Conversational</td>
                  <td className="border border-gray-300 px-3 py-2">Express naturally</td>
                  <td className="border border-gray-300 px-3 py-2">Be conversationally present</td>
                  <td className="border border-gray-300 px-3 py-2">AI citations</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <section className="mb-10">
        ...
        <p className="text-base font-semibold mb-2">Shampoo Example</p>
      ...
      <section className="mb-10">
        ...
        <p className="text-sm font-semibold mb-2">Questions to Ask About GEO Investment</p>
      ...
      <section className="mb-10">
        ...
        <div className="text-sm space-y-2">
          ...
          <p className="font-semibold mt-3">For Brands</p>
          <ul className="list-disc pl-5 space-y-1">
      ...
      {/* Quick Facts */}
      <section className="mb-10 border border-gray-300 rounded p-4">
      ...
      {/* Footer */}
      <footer className="text-center text-xs text-gray-500 border-t border-gray-200 pt-6">
